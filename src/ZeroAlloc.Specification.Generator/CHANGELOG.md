...
Stability milestone — public API of `ZeroAlloc.Specification.Generator` is now considered stable. No code changes from 0.3.0; this release marks the transition out of pre-1.0 SemVer.

## [0.3.0](https://github.com/ZeroAlloc-Net/ZeroAlloc.Specification/compare/ZeroAlloc.Specification.Generator-v0.2.0...ZeroAlloc.Specification.Generator-v0.3.0) (2026-03-18)
